...
### پنجره جزئیات و ویرایش
- دکمه نمایش در تمام جداول
- ویرایش و حذف در پنجره جداگانه
- فیلدها به صورت خودکار از دیتابیس خوانده می‌شوند

### پیش‌نمایش فاکتور
- نمایش حرفه‌ای فاکتور با فونت فارسی
- چاپ با فونت Tahoma/Persian
- سایز A4 افقی

### میانبرهای صفحه‌کلید
- ۱۵ میانبر قابل سفارشی‌سازی
- ذخیره در فایل JSON
- قابل ویرایش از صفحه تنظیمات

### ثبت خطا
- لاگ کامل خطاها در فایل errors.log
- نمایش دیالوگ خطا به کاربر
- جلوگیری از خطا بازگشتی
